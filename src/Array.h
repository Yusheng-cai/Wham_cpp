...
template <typename T> void Matrix<T>::resize(const std::size_t size)
{
    data_.resize(size);
...
template <typename T> void Matrix<T>::resize(std::size_t NR, std::size_t NC)
{
...
template <typename T> Matrix<T>::Matrix(std::size_t NR, std::size_t NC)
{
    AssertValidSize(NR, NC);
    NR_ = NR;
    NC_ = NC;
...
template <typename T> Matrix<T>::Matrix(std::size_t NR, std::size_t NC, T num)
{
    AssertValidSize(NR, NC);
    NR_ = NR;
    NC_ = NC;
...
template <typename T> Matrix<int> Matrix<T>::operator==(const Matrix& other) const
{
    AssertValidSize(NR_, NC_);
    AssertSameSize(other);
...
template <typename T> Matrix<int> Matrix<T>::operator==(T other) const
{
    AssertValidSize(NR_, NC_);
    AssertSameSize(other);

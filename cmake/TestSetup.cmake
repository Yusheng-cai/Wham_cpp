...
function(add_unit_test  TEST_SUBDIR)
  set(options        "")
  ...
  # Register this test
  # TODO: rename
  # register_test_in_namespace(${TEST_EXE} ${TEST_NAMESPACE})

  # TODO: Use fixtures to ensure the test binary is built before it's used?
  #set(BUILD_TEST_EXE build_${TEST_EXE})
  #add_test(NAME ${BUILD_TEST_EXE}
  #  COMMAND ${CMAKE_COMMAND} --target ${TEST_EXE}
  #  )
  #set_tests_properties(${BUILD_TEST_EXE} PROPERTIES FIXTURES_SETUP ${TEST_EXE}_fixture)


  ### Generate tests using this driver ###
